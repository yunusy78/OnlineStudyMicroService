...
public class CommentControllerUnitTest
{
    ...
    {
        var mockDiscountService = new Mock<ICommentService>();
        var identityMock = new Mock<ISharedIdentity>();
        var controller = new CommentsController(identityMock.Object,mockDiscountService.Object);

        // Assuming your service returns a ResponseDto<List<Discount>> for GetAllAsync
        var responseDto = new ResponseDto<List<Comment>> { Data = new List<Comment>() }; // You may adjust this based on your actual implementation
    ...
    public async Task GetByIdAsync_ShouldReturn200Status()
    {
        ...
        // Assuming your service returns a ResponseDto<List<Discount>> for GetAllAsync
        var responseDto = new ResponseDto<Comment> { Data = new Comment() }; // You may adjust this based on your actual implementation
    ...
    public async Task CreateOrder_ShouldReturn200Status()
    {
        ...
        // Assuming your service returns a ResponseDto<List<Discount>> for GetAllAsync
        var responseDto = new ResponseDto<Comment> { Data = new Comment() }; // You may adjust this based on your actual implementation
        mockDiscountService.Setup(service => service.AddAsync(It.IsAny<Comment>())).ReturnsAsync(responseDto);

        // Act
        var result = await controller.CreateOrder(It.IsAny<Comment>());
    ...
    public async Task Update_ShouldReturn200Status()
    {
        ...
        // Assuming your service returns a ResponseDto<List<Discount>> for GetAllAsync
        var responseDto = new ResponseDto<Comment> { Data = new Comment() }; // You may adjust this based on your actual implementation
        mockDiscountService.Setup(service => service.UpdateAsync(It.IsAny<Comment>())).ReturnsAsync(responseDto);

        // Act
        var result = await controller.Update(It.IsAny<Comment>());
